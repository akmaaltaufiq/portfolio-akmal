...
const socialLinks = [
  ...
  {
    platform: "LinkedIn",
    href: "https://id.linkedin.com/in/akmal-taufiqurrahman-686961285",
    ...
    <html lang="en">
      ...
      >
        ...
        <header className="sticky top-0 z-50 flex w-full items-center justify-between px-4 py-2 md:px-8 md:py-3 bg-transparent backdrop-blur-[3px]">
          ...
          <Link href="/" passHref>
            <p className="text-white font-bold text-lg md:text-xl m-4 md:m-10 transition-all duration-300 hover:scale-110 hover:rotate-1 hover:brightness-125 tracking-wide">
              akmaaltaufiq
            </p>
          </Link>
